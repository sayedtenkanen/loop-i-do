...
from docs.agents import AgentRegistry
from docs.automations import AutomationScheduler
from docs.memory import MemoryLayer
from docs.orchestration import LoopConfig, LoopDefinition, LoopOrchestrator
...
async def main():
    ...
    print("✓ Skills engine initialized")
    ...
    _orchestrator = LoopOrchestrator(config)
